            ...
            <div class="flex-1">
              <div class="flex justify-between relative text-sm text-gray-400">
                <div class="sm:truncate inline-block">
                  <a onclick = 'showOverlay()' href = "/users/${post.author.name}" class="inline-block  font-semibold hover:text-orange-600 text-white">${post.author.player}</a> @${post.author.nickname}
                </div>
