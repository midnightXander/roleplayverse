...
urlpatterns = [
    ...
    path('send_request/<uuid:family_id>',views.send_request,name='send_request'),
    ...
    path('family/<uuid:family_id>',views.family_page,name='family_page'),
    path('family/<uuid:family_id>/battles',views.family_battles,name='family_battles'),
    path('family/members/<uuid:family_id>', views.get_members, name = 'family_members'),
