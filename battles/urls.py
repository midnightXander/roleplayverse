...
urlpatterns = [
    ...
    path('rules/<uuid:battle_id>', views.rules,name= 'rules'),
    path('battle_room/<uuid:battle_id>',views.battle_room, name="battle_room"),
    path('textpads/get/<uuid:battle_id>',views.get_textpads, name="get_textpads"),
    path('textpads/send/<uuid:battle_id>',views.send_textpad, name="send_textpad"),
    path('textpads/evaluate/<uuid:battle_id>',views.evaluate_textpad, name='evaluate_textpad'),

    path('declare_winner/<uuid:battle_id>', views.declare_winner, name = "declare_winner"),

    path('refree/send_proposal/<uuid:battle_id>',views.refree_proposal,name="refree_proposal"),
    ...
    path('referee/rate/<uuid:battle_id>',views.rate_referee, name = 'rate_referee'),
